...
export default function Servers({servers}: ServersInterface){
    ...
    return (
        ...
        <Section title="Connecting to a server" content={content} sideContent={<VerticalNavigation serverNames={serverNames} current={current} setCurrent={setCurrent} />} stickySideContent={true}  />
        </div>
    )
}