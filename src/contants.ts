...
export const CLIENT_CREDENTIALS_DESCRIPTION = "The Client Credentials grant type is used by clients to obtain an access token outside of the context of a user.";
export const PASSWORD_TEXT = 'Password';
export const PASSWORD_DESCRIPTION = 'The Password grant type is a legacy way to exchange a user\'s credentials for an access token.';
export const AUTHORIZATION_CODE_TEXT = 'Authorization Code';
export const AUTHORIZATION_CODE_DESCRIPTION = 'The Authorization Code grant type is used by confidential and public clients to exchange an authorization code for an access token.';