    ...
    <dl>
      {details.licenseName && (
        <DefinitionListItem
          ...
          className="inline-block mb-4 text-neutral-700 hover:text-pink-500"
        />
      )}
      {details.externalDocsUrl && (
        <DefinitionListItem
          ...
          className="inline-block mb-4 text-neutral-700 hover:text-secondary-500"
        />
      )}
      {details.contactEmail && (
        <DefinitionListItem
          ...
          className="inline-block mb-4 text-neutral-700 hover:text-green-500"
        />
      )}
      {details.contactUrl && (
        <DefinitionListItem
      ...
      {details.tags && (
        <DefinitionListItem
          IconClass={IconTag}
          term={TAGS_TEXT}
          className="mb-2 text-neutral-700 inline-block"
          vertical
          text={
            details.tags && (
