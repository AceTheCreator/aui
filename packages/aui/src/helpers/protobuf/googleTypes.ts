/**
 * Bundled google/type/*.proto definitions (pre-parsed to protobufjs JSON
 * descriptors) so `.proto` sources can `import "google/type/…"` without any
 * filesystem or network access. `google/protobuf/*` well-known types come
 * from protobufjs's own `protobuf.common`; this table covers the googleapis
 * common types (Money, Date, LatLng, …) plus empty stubs for the
 * validate/buf.validate option protos.
 *
...
export const googleProtoTypes: Record<string, Record<string, unknown>> = {
