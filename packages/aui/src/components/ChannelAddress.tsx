        ...
        return (
          ...
          >
            ...
            {description && isHovered && (
              <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2.5 py-1.5 bg-neutral-50 text-foreground-muted text-xs rounded whitespace-nowrap pointer-events-none z-20 shadow-lg text-center leading-snug">
                {description}
              </span>
            )}
          </span>
